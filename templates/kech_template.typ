// ==============================================================================
// MASTER TYPST TEMPLATE FOR CHEMISTRY (Automated Subject Generator)
// ==============================================================================

#let brand-primary = rgb("#1b4f9c")
#let brand-callout-bg = rgb("#ebf5ed")
#let brand-callout-border = rgb("#5ca374")
    ...
    header: context {
      ...
      if page-num > 1 {
        if calc.even(page-num) {
          text(size: 8.5pt, fill: rgb("#4a4a4a"))[#page-num #h(1fr) *CHEMISTRY*]
        } else {
