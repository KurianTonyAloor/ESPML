// ==============================================================================
// MASTER TYPST TEMPLATE FOR BIOLOGY (Automated Subject Generator)
// ==============================================================================

#let brand-primary = rgb("#1e6b37")
#let brand-callout-bg = rgb("#f1f8e9")
#let brand-callout-border = rgb("#7cb342")
#let brand-problem-bg = rgb("#f3e5f5")
#let brand-problem-border = rgb("#ab47bc")
#let brand-table-header = rgb("#c8e6c9")
#let brand-table-row-even = rgb("#e8f5e9")
