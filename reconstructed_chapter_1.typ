...
#columns(2, gutter: 15pt)[
  ...
  A vast number of statements and material described in the ancient Vedic literature can be shown to agree with modern scientific findings. Copper utensils, iron, gold, silver ornaments and terracotta discs and painted grey pottery have been found in many archaeological sites in north India. Sushruta

  Samhita explains the importance of Alkalies. The Charaka Samhita mentions ancient indians who knew how to prepare sulphuric acid, nitric acid and oxides of copper, tin and zinc; the sulphates of copper, zinc and iron and the carbonates of lead and iron.
  ...
  #ncert-figure("./images/john_dalton.png", caption: "", width: 33%)
  ...
  #ncert-h2("1.1 importance of chemiStry")
  ...
  #ncert-h2("1.2.1 States of matter")
  ...
  #ncert-figure("./images/fig__1_1.png", caption: "", width: 95%)
  ...
  #ncert-figure("./images/fig__1_2.png", caption: "", width: 90%)
  ...
  #ncert-figure("./images/fig__1_4.png", caption: "", width: 95%)
  ...
  #ncert-h2("1.3 propertieS of matter anD their meaSUrement")

  #ncert-h2("1.3.1 physical and chemical properties")
  ...
  #ncert-h2("1.3.2 measurement of physical properties")
  ...
  #ncert-h2("1.3.3 the international System of Units (Si)")
...
#ncert-table(caption: "Table 1.2 Definitions of SI Base Units", headers: ("Unit of length", "metre", "The metre, symbol m is the SI unit of length. It is defined by taking the fixed numerical value of the speed of light in vacuum c to be 299792458 when expressed in the unit ms–1, where the second is defined in terms of the caesium frequency ΔνCs."), rows: (("Unit of mass", "kilogram", "The kilogram, symbol kg, is the SI unit of mass. It is defined by taking the fixed numerical value of the Planck constant h to be 6.62607015×10–34 when expressed in the unit Js, which is equal to kgm2s–1, where the metre and the second are defined in terms of c and ΔνCs."), ("Unit of time", "second", "The second, symbol s, is the SI unit of time. It is defined by taking the fixed numerical value of the caesium frequency ΔνCs, the unperturbed ground-state hyperfine transition frequency of the caesium-133 atom, to be 9192631770 when expressed in the unit Hz, which is equal to s–1."), ("Unit of electric current", "ampere", "The ampere, symbol A, is the SI unit of electric current. It is defined by taking the fixed numerical value of the elementary charge e to be 1.602176634×10–19 when expressed in the unit C, which is equal to As, where the second is defined in terms of ΔνCs."), ("Unit of thermodynamic temperature", "kelvin", "The kelvin, symbol K, is the SI unit of thermodynamic temperature. It is defined by taking the fixed numerical value of the Boltzmann constant k to be 1.380649×10–23 when expressed in the unit JK–1, which is equal to kgm2s–2K–1 where the kilogram, metre and second are defined in terms of h, c and ΔνCs."), ("Unit of amount of substance", "mole", "The mole, symbol mol, is the SI unit of amount of substance. One mole contains exactly 6.02214076×1023 elementary entities. This number is the fixed numerical value of the Avogadro constant, NA, when expressed in the unit mol–1 and is called the Avogadro number. The amount of substance, symbol n, of a system is a measure of the number of specified elementary entities. An elementary entity may be an atom, a molecule, an ion, an electron, any other particle or specified group of particles."), ("Unit of luminous intensity", "candela", "The candela, symbol cd, is the SI unit of luminous intensity in a given direction. It is defined by taking the fixed numerical value of the luminous efficacy of monochromatic radiation of frequency 540×1012 Hz, Kcd, to be 683 when expressed in the unit lm W–1, which is equal to cd sr W–1, or cd sr kg–1 m–2 s3, where the kilogram, metre and second are defined in terms of h, c and ΔνCs.")), width: 100%)
...
#columns(2, gutter: 15pt)[
  ...
  #align(center)[#text(style: "italic", size: 8.5pt)[Fig. 1.6 helps to visualise these relations.]]
  ...
  #ncert-figure("./images/fig__1_8.png", caption: "", width: 95%)
  ...
  #ncert-h2("1.4.1	Scientific	Notation")
  ...
  #ncert-problem-box(title: "Step 3. Divide each of the mole values obtained above by the smallest number amongst them", [Since 2.021 is smallest value, division by it gives a ratio of 2:1:1 for H:C:Cl.
...
(a) Determine empirical formula mass by adding the atomic masses of various atoms present in the empirical formula.For CH2Cl, empirical formula mass is 12.01 + (2 ×1.008) + 35.453= 49.48 g(b) Divide Molar mass by empirical formula mass

= 2 = (n)(c) Multiply empirical formula by n obtained above to get the molecular formula
...
Empirical formula = CH2Cl, n = 2. Hence molecular formula is C2H4Cl2.])
  ...
  #ncert-table(caption: "Table 1.4 Data to Illustrate Precision and Accuracy", headers: ("Student A", "1.95", "1.93", "1.940"), rows: (("Student B", "1.94", "2.05", "1.995"), ("Student C", "2.01", "1.99", "2.000")), width: 100%)
  ...
  #ncert-h2("1.4.3 Dimensional analysis")

  Often while calculating, there is a need to convert units from one system to the other. The method used to accomplish this is called factor label method or unit factor method or dimensional analysis. This is illustrated below. example
  ...
  #ncert-h2("1.5 laWS of chemical comBinationS")

  The combination of elements to form compounds is governed by the following five basic laws.

  #ncert-h2("1.5.1 law of conservation (1743–1794) of mass")
  ...
  Proust worked with two Joseph Proust samples of cupric carbonate (1754–1826) — one of which was of natural origin and the other was synthetic. He found that the composition of elements present in it was same for both the samples as shown below:
  ...
  #ncert-h2("1.5.3 law of multiple proportions")
  ...
  Quareqa edi believed at that time that Carreto atoms of the same kind (1776–1856) cannot combine and molecules of oxygen or hydrogen containing two atoms did not exist. Avogadro’s proposal was published in the French Journal de Physique. In spite of being correct, it did not gain much support.
  ...
  #ncert-h2("1.7.2 average atomic mass")

  #ncert-table(caption: "", headers: ("Isotope", "Relative Abundance (%)", "Atomic Mass (amu)"), rows: (("12C", "98.892", "12"), ("13C", "1.108", "13.00335"), ("14C", "2 × 10⁻¹²", "14.00317")), width: 100%)
  ...
  = 2 × atomic mass of hydrogen + 1× atomic  mass of oxygen = 2 (1.008 u) + 16.00 u

  = 18.02 u

  #ncert-h2("1.7.4 formula mass")
  ...
  #ncert-problem-box(title: "Problem 1.1", [Calculate the molecular mass of glucose (C6H12O6) molecule.
...
Molecular mass of glucose (C6H12O6) = 6 (12.011 u) + 12 (1.008 u) +                                        6 (16.00 u)= (72.066 u) + (12.096 u) +                                      (96.00 u)=  180.162 u])
  ...
  #ncert-h2("24.02g 46.068g")

  = 	 ×100 = 52.14%

  Mass per cent of hydrogen

  #ncert-h2("6.048g 46.068g")

  = 	 ×100 = 13.13%

  Mass per cent of oxygen

  #ncert-h2("16.00g 46.068g")
  ...
  #ncert-h2("1.9.1 empirical formula for molecular   	formula")
  ...
  #ncert-h1("1.10 Stoichiometry anD")
  ...
  #ncert-h1("22.7 L of CH4(g) reacts with 45.4 L of O2 (g) to give 22.7 L of CO2 (g) and 45.4 L of H2O(g)")
  ...
  #ncert-h2("1.10.1 limiting reagent")
...
#ncert-full-width-box(title: "Balancing a chemical equation", [According to the law of conservation of mass, a balanced chemical equation has the same number of atoms of each element on both sides of the equation. Many chemical equations can be balanced by trial and error. Let us take the reactions of a few metals and non-metals with oxygen to give oxides 	 	4 Fe(s)  +  3O2(g)  → 2Fe2O3(s)	 	(a) balanced equation	 	2 Mg(s)  +  O2(g)  → 2MgO(s)		(b) balanced equation	 	P4(s)   +  O2 (g)  → P4O10(s)		(c) unbalanced equationEquations (a) and (b) are balanced, since there are same number of metal and oxygen atoms on each side of the equations. However equation (c) is not balanced. In this equation, phosphorus atoms are balanced but not the oxygen atoms. To balance it, we must place the coefficient 5 on the left of oxygen on the left side of the equation to balance the oxygen atoms appearing on the right side of the equation.	 	P4(s)  +  5O2(g)  → P4O10(s)		balanced equation          Now, let us take combustion of propane, C3H8. This equation can be balanced in steps.Step 1 Write down the correct formulas of reactants and products. Here, propane and oxygen are reactants, and carbon dioxide and water are products.	 	C3H8(g)  +  O2(g) → CO2 (g) + H2O(l)   unbalanced equationStep 2 Balance the number of C atoms:  Since 3 carbon atoms are in the reactant, therefore, three CO2 molecules are required on the right side.	    	C3H8 (g)  +  O2 (g) → 3CO2 (g) + H2O (l)Step 3 Balance the number of H atoms: on the left there are 8 hydrogen atoms in the reactants however, each molecule of water has two hydrogen atoms, so four molecules of water will be required for eight hydrogen atoms on the right side.	 	C3H8  (g) +O2 (g)  → 3CO2  (g)+4H2O (l)Step 4 Balance the number of O atoms:  There are 10 oxygen atoms on the right side (3 × 2 = 6 in CO2 and 4×1= 4 in water).  Therefore, five O2 molecules are needed to supply the required 10 CO2 and 4×1= 4 in water).  Therefore, five O2 molecules are needed to supply the required 10 oxygen atoms.	 	C3H8 (g) +5O2   (g)  →  3CO2 (g) + 4H2O (l)Step 5 Verify that the number of atoms of each element is balanced in the final equation. The equation shows three carbon atoms, eight hydrogen atoms, and 10 oxygen atoms on each side.
...
#columns(2, gutter: 15pt)[
  4 Fe(s)  +  3O2(g)  → 2Fe2O3(s)  	(a) balanced equation   	2 Mg(s)  +  O2(g)  → 2MgO(s) 	 	(b) balanced equation
  ...
  #ncert-problem-box(title: "the limiting reagent in the production of NH3 in this situation.", [Solution
...
= 17.86×102  molNumber of moles of H2
...
2.mol Nmol Hgmol Ng = 5.36 × 103 mol H2But we have only 4.96×103 mol H2. Hence, dihydrogen is the limiting reagent in this case. So, NH3(g) would be formed only from that amount of available dihydrogen i.e., 4.96 × 103 mol
...
. g NHgmol NHg])
  ...
  In fact for such calculations, a general formula, M1×V1 =  M2 × V2 where M and V are molarity and volume, respectively, can be used. In this case, M1 is equal to 0.2M; V1 = 1000 mL and, M2 = 1.0M; V2 is to be calculated. Substituting the values in the formula:

  #ncert-h1("0.2 M × 1000 mL = 1.0 M × V2")
  ...
  Since measurements involve recording of data, which are always associated with a certain amount of uncertainty, the proper handling of data obtained by measuring the quantities is very important. The measurements of quantities in chemistry are spread over a wide . Hence, a convenient system of expressing the numbers in
  ...
  which has an exact value of 12u. Usually, the atomic mass used for an element is the  obtained by taking into account the natural abundance of different molecular mass of a molecule is obtained by taking sum of
  ...
  indicate the molar ratios and the respective number of particles taking part in a particular reaction. The quantitative study of the reactants required or the products formed is called
  ...
  #ncert-h2("% natural abundance  	molar mass")
  ...
  #ncert-h1("1.21 The following data are obtained when dinitrogen and dioxygen react together to form different compounds:")

  #ncert-h2("mass of dinitrogen 	mass of dioxygen")
  ...
  #ncert-h1("1.22 	If the speed of light is 3.0 × 108 m s–1, calculate the distance covered by light in")

  #ncert-h2("2.00 ns.")

  #ncert-h1("1.23 	In a reaction")
  ...
  #ncert-h1("1.28 	Which one of the following will have the largest number of atoms?")
  ...
  #ncert-h2("isotope 	 	isotopic molar mass  	abundance")
